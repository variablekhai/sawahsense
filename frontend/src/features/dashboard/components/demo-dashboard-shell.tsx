...
export function DemoDashboardShell() {
  ...
  const confirmFieldRef = useRef<((name: string, variety: string, sowingDate: string) => void) | null>(null);
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          left: isMobile ? 0 : showOnboarding ? `${sidebarWidth}px` : `${sidebarWidth}px`,
          right: 0,
          bottom: 0,
        }}
      >
