...
>
> But watch what happens when we switch back to NDVI and look closely at the southeast corner."
...
> "When the system detects an anomaly, it fires an alert — automatically, in real time, in Bahasa Malaysia."
...
### 📷 Bonus: Image Diagnostics (within Pak Tani)
